...
<div class="super_container">
	...
	<div style="text-align:center;width:700px;margin:0px auto; top:150px; margin-bottom:200px; overflow:auto; font-family:Microsoft JhengHei; ">
			<?php
				$con = new mysqli("localhost", "root", "123456", "friyay");
				...
				if (@$_POST['action'] == 'Delete') {
					...
					for($i = 0; $i < count($delete_array) ; $i++){
						$sql = "DELETE FROM cart WHERE pName = '$delete_array[$i]' and cID = '$cID'";
						$con->query($sql);
					}
				}
			?>
			...
			<?php
				...
				<th width='50' bgcolor='#FFDAB9'>整筆刪除</th>
				</tr>";
				...
				?>
				<td></td><td></td><td></td>
				<td><button class="btn btn-mini" style="height:30px;border:3px gray double;background-color:white;font-size:12px; " type="submit" name ="action" formmethod="post" value="Delete" >Delete</td>
				<?php
				echo "</tr>";
				echo "</table>";
