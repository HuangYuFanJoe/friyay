				...
				while($row = mysqli_fetch_array($result))
				{
					?>
					  ...
					  echo "<td style=\"vertical-align:middle;\"> <img src=\"" . $row['pImage'] . "\" width=\"200\"></td>";
						...
						{
							?>
							<td style="vertical-align:middle;" ><button class="btn btn-mini" style="border:3px gray double;background-color:white;" type="submit" formmethod="get" onclick="location.href='get.php?pName=<?=$row['pName']?>&pPrice=<?=$row['pPrice']?>&pNum=1'" >+</button></td></tr>
				 		<?php
						}
						else
							echo "</tr>";
